...
# Note: user must download and save this image file in "png" format before running this program.
# http://findicons.com/icon/44290/solar_eclipse
...
eclipseCities %>%
    ...
    addCircles(weight=1, radius=sqrt(eclipseCities$pop)*300, color="03F", opacity=0.5)
